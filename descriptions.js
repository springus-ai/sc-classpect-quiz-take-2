const classpectDescriptions = {
    ...
    "Space": `<strong>Espaço:</strong> A sua forma de processar o mundo baseia-se na compreensão de que a realidade possui um ritmo próprio e limites que precisam ser respeitados. Internamente, você cultiva uma paciência profunda, motivada pela certeza de que forçar o andamento de qualquer processo resulta na ruína de sua estrutura. A sua tranquilidade mental e o seu foco dependem de aceitar o tempo natural das coisas. Psicologicamente, você lida com uma desconexão muito específica. Existe uma facilidade imensa em observar o seu círculo social de fora e entender exatamente como as dinâmicas do grupo funcionam, acompanhada de uma dificuldade crônica em se envolver com a volatilidade emocional dessas pessoas. Lidar com a intensidade dos afetos e com o caos interpessoal gera um atrito que você prefere evitar. A sua mente resolve esse desconforto criando um vácuo intencional: você cede território para acomodar as necessidades dos amigos, enquanto mantém a sua própria esfera para se proteger de colisões afetivas. `,
    ...
    "Mind": `<strong>Mente:</strong> Você encara a sua própria personalidade como um guarda-roupa versátil. Adaptar o tom de voz, o vocabulário e a postura dependendo de quem está à sua frente é uma medida prática para desarmar conflitos iminentes e guiar a situação para um desfecho seguro. A identidade opera como uma ferramenta flexível, moldada para garantir o funcionamento do ambiente. Ao avaliar os acontecimentos, as intenções ou emoções perdem o peso; você foca inteiramente nas ações concretas e nas consequências que elas geram. Diante de um problema, a sua prioridade é encontrar a rota mais eficiente para consertar o estrago, suspendendo impulsos afetivos para tomar as decisões difíceis que preservarão a estrutura do grupo. A sua estabilidade nasce do ensaio contínuo e da certeza de que, ao dominar as variáveis e vestir a máscara adequada, você sempre terá a situação sob controle.`,
    ...
    "Blood": `<strong>Sangue:</strong> A realidade de um indivíduo atrelado ao Sangue exige a renúncia da própria liberdade pessoal, motivada pela necessidade de manter o grupo unido para garantir a sobrevivência de todos. A vida em conjunto cobra um preço contínuo em forma de obrigações e expectativas diárias. Como a sua identidade e o seu senso de valor estão apoiados diretamente no convívio social, a solidão torna-se um perigo iminente e prático. Você se mantém em um estado de alerta contínuo, observando de perto as relações ao seu redor para antecipar desentendimentos e impedir que a equipe se desfaça. Em cenários onde a sociedade maior o exclui ou o ameaça, você aplica essa mesma dedicação na construção de famílias escolhidas e comunidades de apoio mútuo, criando ambientes seguros através de acordos de convivência. O sacrifício pessoal atua como um meio eficaz de acalmar os ânimos e garantir a cooperação de todos. Assumir a responsabilidade constante de vigiar atitudes e exigir compromissos gera um desgaste natural, fundamentando a sua rotina no esforço incessante de preservar as alianças que asseguram o seu lugar seguro no mundo.`,
