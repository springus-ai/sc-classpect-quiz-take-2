...
function showAspectResultScreen() {
    ...
    if (isForced) {
        transitionText = isEn
            ? `The universe has chosen for you. Try not to waste this second chance on Classes.`
        ...
        return `
            ...
            >
                ...
                style="
                    ...
                    height: 26px; 
                    object-fit: contain;
                    filter: drop-shadow(0px 0px 3px rgba(255, 255, 255, 0.95)) drop-shadow(0px 0px 1px #ffffff);
                " 
...
function openLibrary(section = 'aspects') {
    ...
    const labelAspect = isEn ? "Aspect" : "Aspecto";
    const btnRead = isEn ? "Read combination" : "Ler combinação"; 
